...
lyr_OSMStandard_0.setVisible(true);lyr_tramosactualestramos_actuales_1.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_tramosactualestramos_actuales_1];
...
lyr_tramosactualestramos_actuales_1.on('precompose', function(evt) {
